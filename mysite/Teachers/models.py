...
class TeachersInfo(models.Model):
    ...
    maleOrFemale = models.CharField(('Sexo'), max_length=1, choices=MaleOrFemale)
    contractType = models.CharField(('Tipo de contrato'), max_length=100, choices=ContractType)
